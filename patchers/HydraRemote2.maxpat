...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 750.0, 515.0, 86.0, 20.0 ],
					"text" : "s fader-update"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 735.0, 490.0, 34.0, 20.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 735.0, 540.0, 86.0, 20.0 ],
					"text" : "s update-all"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 735.0, 465.0, 79.0, 20.0 ],
					"text" : "route recall"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1050.0, 390.0, 86.0, 20.0 ],
					"text" : "s update-all"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1065.0, 365.0, 86.0, 20.0 ],
					"text" : "s fader-update"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1050.0, 310.0, 48.0, 20.0 ],
					"text" : "t b b b"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1080.0, 340.0, 100.0, 20.0 ],
					"text" : "s clear-all"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1050.0, 270.0, 75.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 905.0, 270.0, 75.0, 30.0 ],
					"prototypename" : "M4L.toggle",
					"rounded" : 0.0,
					"text" : "Initialize",
					"textcolor" : [ 0.101961, 0.121569, 0.172549, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 905.0, 310.0, 77.0, 20.0 ],
					"text" : "s INITIALIZE"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 750.0, 370.0, 138.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 750.0, 320.0, 77.0, 20.0 ],
					"text" : "r INITIALIZE"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 750.0, 345.0, 82.0, 20.0 ],
					"text" : "v JSONPATH"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 905.0, 450.0, 82.0, 20.0 ],
					"text" : "v JSONPATH"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 905.0, 425.0, 161.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 905.0, 395.0, 100.0, 20.0 ],
					"text" : "regexp (.+/).+/"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 905.0, 340.0, 100.0, 20.0 ],
					"text" : "loadmess path"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 905.0, 365.0, 69.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 720.0, 270.0, 91.0, 18.0 ],
					"text" : "storagewindow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 735.0, 395.0, 156.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 795.0, 490.0, 120.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 735.0, 295.0, 98.0, 20.0 ],
